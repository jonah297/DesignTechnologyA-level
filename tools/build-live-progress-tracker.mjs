...
const featureRows = [
  ...
  ["F010", "Class progress overview", "Teacher", "Needs Polish", "P1", "Class page lists students with rank, mastery, assignment state, last active, and support signals.", "Avoid crowded tables and reduce columns on smaller screens.", "src/App.jsx; src/styles.css; LIVE_HANDOVER.md"],
  ["F011", "Student detail modal", "Teacher", "Mostly Complete", "P1", "Teacher can open a student view with topic breakdown, support state, and parents' evening review.", "Needs visual smoke for modal position/overlay issues.", "src/App.jsx"],
...
const sprintRows = [
  ...
  ["SP-010", "UI polish and responsive tables", "UX", "2026-07", "In Progress", "Collapsed long tables, compact actions, dashboard chart work, modal fixes.", "More visual/device review needed.", "src/styles.css"],
...
const issueRows = [
  ...
  ["I006", "Class progress tables on small devices", "UX", "Needs Polish", "P1", "Long tables can become cramped or hide important columns.", "Continue responsive table audits.", "src/styles.css"],
  ["I007", "Student detail modal visual issues", "UX", "Needs Manual Review", "P1", "Past notes mention modal opening low/overlaying buttons.", "Visual smoke required.", "LIVE_HANDOVER.md"],
